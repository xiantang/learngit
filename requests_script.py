...
User-Agent:Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.119 Safari/537.36'''
    ...
    proxy=[
{"proxy_scheme": "http", "proxy": "http://112.228.159.80:8118"},
{"proxy_scheme": "http", "proxy": "http://58.216.202.149:8118"},
{"proxy_scheme": "http", "proxy": "http://118.114.77.47:8080"},
{"proxy_scheme": "https", "proxy": "https://220.162.150.33:8888"},
{"proxy_scheme": "http", "proxy": "http://183.48.91.80:8118"}
]
    def __init__(self):
        with open('zhaobiao.csv','w') as  f:
            f_csv=csv.writer(f)
